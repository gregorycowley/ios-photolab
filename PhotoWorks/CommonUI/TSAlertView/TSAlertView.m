...
- (void) onButtonPress: (id) sender
{
	...
	if ( [self.delegate respondsToSelector: @selector(tsalertView:clickedButtonAtIndex:)] )
	{
		[self.delegate tsalertView: self clickedButtonAtIndex: buttonIndex ];
	}
